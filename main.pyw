...
timezone_mapping = {
    ...
    "Edinburgh": "Europe/London",  # Edinburgh in the same timezone as London
    "Manchester": "Europe/London",  # Manchester in the same timezone as London
    "Glasgow": "Europe/London",  # Glasgow in the same timezone as London
    "Cardiff": "Europe/London",  # Cardiff in the same timezone as London
    "Belfast": "Europe/London",  # Belfast in the same timezone as London
    "Liverpool": "Europe/London",  # Liverpool in the same timezone as London
    "Barcelona": "Europe/Madrid",  # Barcelona in the same timezone as Madrid
    "Valencia": "Europe/Madrid",  # Valencia in the same timezone as Madrid
    "Seville": "Europe/Madrid",  # Seville in the same timezone as Madrid
    "Malaga": "Europe/Madrid",  # Malaga in the same timezone as Madrid
    "Bilbao": "Europe/Madrid",  # Bilbao in the same timezone as Madrid
    "Granada": "Europe/Madrid",  # Granada in the same timezone as Madrid
    "Toledo": "Europe/Madrid",  # Toledo in the same timezone as Madrid
    "Salamanca": "Europe/Madrid",  # Salamanca in the same timezone as Madrid
    "Santander": "Europe/Madrid",  # Santander in the same timezone as Madrid
    "Zaragoza": "Europe/Madrid",  # Zaragoza in the same timezone as Madrid
    "Palma": "Europe/Madrid",  # Palma in the same timezone as Madrid
    "Ibiza": "Europe/Madrid",  # Ibiza in the same timezone as Madrid
    "Mallorca": "Europe/Madrid",  # Mallorca in the same timezone as Madrid
    "Menorca": "Europe/Madrid",  # Menorca in the same timezone as Madrid
    "Florence": "Europe/Rome",  # Florence in the same timezone as Rome
    "Venice": "Europe/Rome",  # Venice in the same timezone as Rome
    "Milan": "Europe/Rome",  # Milan in the same timezone as Rome
    "Naples": "Europe/Rome",  # Naples in the same timezone as Rome
    "Turin": "Europe/Rome",  # Turin in the same timezone as Rome
    "Bologna": "Europe/Rome",  # Bologna in the same timezone as Rome
    "Genoa": "Europe/Rome",  # Genoa in the same timezone as Rome
    "Pisa": "Europe/Rome",  # Pisa in the same timezone as Rome
    "Verona": "Europe/Rome",  # Verona in the same timezone as Rome
    "Brescia": "Europe/Rome",  # Brescia in the same timezone as Rome
    "Rimini": "Europe/Rome",  # Rimini in the same timezone as Rome
    "Cagliari": "Europe/Rome",  # Cagliari in the same timezone as Rome
    "Catania": "Europe/Rome",  # Catania in the same timezone as Rome
    "Sicily": "Europe/Rome",  # Sicily in the same timezone as Rome
    "Sardinia": "Europe/Rome",  # Sardinia in the same timezone as Rome
    "Riga": "Europe/Riga",
    ...
    "Kiev": "Europe/Kiev",
    "Odessa": "Europe/Kiev",  # Odessa in the same timezone as Kiev
    "Kharkiv": "Europe/Kiev",  # Kharkiv in the same timezone as Kiev
    "Lviv": "Europe/Kiev",  # Lviv in the same timezone as Kiev
    "Minsk": "Europe/Minsk",
    "Almaty": "Asia/Almaty",
    "Astana": "Asia/Almaty",  # Astana in the same timezone as Almaty
    "Nur-Sultan": "Asia/Almaty",  # Nur-Sultan in the same timezone as Almaty
    "Karaganda": "Asia/Almaty",  # Karaganda in the same timezone as Almaty
    "Pavlodar": "Asia/Almaty",  # Pavlodar in the same timezone as Almaty
    "Shymkent": "Asia/Almaty",  # Shymkent in the same timezone as Almaty
    "Ust-Kamenogorsk": "Asia/Almaty",  # Ust-Kamenogorsk in the same timezone as Almaty
    "Petropavlovsk": "Asia/Almaty",  # Petropavlovsk in the same timezone as Almaty
    "Omsk": "Asia/Omsk",
    ...
    "Baku": "Asia/Baku",
    "Kabul": "Asia/Kabul",
    "Islamabad": "Asia/Karachi",  # Islamabad in the same timezone as Karachi
    "Lahore": "Asia/Karachi",  # Lahore in the same timezone as Karachi
    "Karachi": "Asia/Karachi",
    "Kolkata": "Asia/Kolkata",
    "Mumbai": "Asia/Kolkata",  # Mumbai in the same timezone as Kolkata
    "Chennai": "Asia/Kolkata",  # Chennai in the same timezone as Kolkata
    "Bangalore": "Asia/Kolkata",  # Bangalore in the same timezone as Kolkata
    "Hyderabad": "Asia/Kolkata",  # Hyderabad in the same timezone as Kolkata
    "Ahmedabad": "Asia/Kolkata",  # Ahmedabad in the same timezone as Kolkata
    "Pune": "Asia/Kolkata",  # Pune in the same timezone as Kolkata
    "Surat": "Asia/Kolkata",  # Surat in the same timezone as Kolkata
    "Jaipur": "Asia/Kolkata",  # Jaipur in the same timezone as Kolkata
    "Lucknow": "Asia/Kolkata",  # Lucknow in the same timezone as Kolkata
    "Kanpur": "Asia/Kolkata",  # Kanpur in the same timezone as Kolkata
    "Nagpur": "Asia/Kolkata",  # Nagpur in the same timezone as Kolkata
    "Indore": "Asia/Kolkata",  # Indore in the same timezone as Kolkata
    "Thane": "Asia/Kolkata",  # Thane in the same timezone as Kolkata
    "Bhopal": "Asia/Kolkata",  # Bhopal in the same timezone as Kolkata
    "Visakhapatnam": "Asia/Kolkata",  # Visakhapatnam in the same timezone as Kolkata
    "Patna": "Asia/Kolkata",  # Patna in the same timezone as Kolkata
    "Vadodara": "Asia/Kolkata",  # Vadodara in the same timezone as Kolkata
    "Ludhiana": "Asia/Kolkata",  # Ludhiana in the same timezone as Kolkata
    "Agra": "Asia/Kolkata",  # Agra in the same timezone as Kolkata
    "Varanasi": "Asia/Kolkata",  # Varanasi in the same timezone as Kolkata
    "Raipur": "Asia/Kolkata",  # Raipur in the same timezone as Kolkata
    "Nashik": "Asia/Kolkata",  # Nashik in the same timezone as Kolkata
    "Aurangabad": "Asia/Kolkata",  # Aurangabad in the same timezone as Kolkata
    "Amritsar": "Asia/Kolkata",  # Amritsar in the same timezone as Kolkata
    "Meerut": "Asia/Kolkata",  # Meerut in the same timezone as Kolkata
    "Jabalpur": "Asia/Kolkata",  # Jabalpur in the same timezone as Kolkata
    "Jamshedpur": "Asia/Kolkata",  # Jamshedpur in the same timezone as Kolkata
    "Asansol": "Asia/Kolkata",  # Asansol in the same timezone as Kolkata
    "Allahabad": "Asia/Kolkata",  # Allahabad in the same timezone as Kolkata
    "Kolkata": "Asia/Kolkata",  # Kolkata in the same timezone as Kolkata
    "Srinagar": "Asia/Kolkata",  # Srinagar in the same timezone as Kolkata
    "Thiruvananthapuram": "Asia/Kolkata",  # Thiruvananthapuram in the same timezone as Kolkata
    "Kochi": "Asia/Kolkata",  # Kochi in the same timezone as Kolkata
    "Kozhikode": "Asia/Kolkata",  # Kozhikode in the same timezone as Kolkata
    "Kollam": "Asia/Kolkata",  # Kollam in the same timezone as Kolkata
    "Thrissur": "Asia/Kolkata",  # Thrissur in the same timezone as Kolkata
    "Palakkad": "Asia/Kolkata",  # Palakkad in the same timezone as Kolkata
    "Alappuzha": "Asia/Kolkata",  # Alappuzha in the same timezone as Kolkata
    "Pathanamthitta": "Asia/Kolkata",  # Pathanamthitta in the same timezone as Kolkata
    "Kannur": "Asia/Kolkata",  # Kannur in the same timezone as Kolkata
    "Kasaragod": "Asia/Kolkata",  # Kasaragod in the same timezone as Kolkata
    "Wayanad": "Asia/Kolkata",  # Wayanad in the same timezone as Kolkata
    "Puducherry": "Asia/Kolkata",  # Puducherry in the same timezone as Kolkata
    "Lakshadweep": "Asia/Kolkata",  # Lakshadweep in the same timezone as Kolkata
    "Andaman and Nicobar Islands": "Asia/Kolkata",  # Andaman and Nicobar Islands in the same timezone as Kolkata
    ...
    "Dhaka": "Asia/Dhaka",
    "Yangon": "Asia/Yangon",
    "Naypyidaw": "Asia/Yangon",  # Naypyidaw in the same timezone as Yangon
    "Mandalay": "Asia/Yangon",  # Mandalay in the same timezone as Yangon
    "Bagan": "Asia/Yangon",  # Bagan in the same timezone as Yangon
    "Phnom Penh": "Asia/Phnom_Penh",
    "Vientiane": "Asia/Vientiane",
    "Hanoi": "Asia/Ho_Chi_Minh",  # Hanoi in the same timezone as Ho Chi Minh City
    "Ho Chi Minh City": "Asia/Ho_Chi_Minh",
    "Haiphong": "Asia/Ho_Chi_Minh",  # Haiphong in the same timezone as Ho Chi Minh City
    "Da Nang": "Asia/Ho_Chi_Minh",  # Da Nang in the same timezone as Ho Chi Minh City
    "Can Tho": "Asia/Ho_Chi_Minh",  # Can Tho in the same timezone as Ho Chi Minh City
    "Hue": "Asia/Ho_Chi_Minh",  # Hue in the same timezone as Ho Chi Minh City
    "Nha Trang": "Asia/Ho_Chi_Minh",  # Nha Trang in the same timezone as Ho Chi Minh City
    "Buon Ma Thuot": "Asia/Ho_Chi_Minh",  # Buon Ma Thuot in the same timezone as Ho Chi Minh City
    "Vung Tau": "Asia/Ho_Chi_Minh",  # Vung Tau in the same timezone as Ho Chi Minh City
    "Phu Quoc": "Asia/Ho_Chi_Minh",  # Phu Quoc in the same timezone as Ho Chi Minh City
    "Hong Kong": "Asia/Hong_Kong",
    "Macau": "Asia/Macau",
    "Taipei": "Asia/Taipei",
    "Seoul": "Asia/Seoul",
    ...
    "Singapore": "Asia/Singapore",
    "Kuching": "Asia/Kuching",  # Kuching in the same timezone as Kuala Lumpur
    "George Town": "Asia/Kuala_Lumpur",  # George Town in the same timezone as Kuala Lumpur
    "Kota Kinabalu": "Asia/Kuala_Lumpur",  # Kota Kinabalu in the same timezone as Kuala Lumpur
    "Miri": "Asia/Kuching",  # Miri in the same timezone as Kuching
    "Malacca City": "Asia/Kuala_Lumpur",  # Malacca City in the same timezone as Kuala Lumpur
    "Johor Bahru": "Asia/Kuala_Lumpur",  # Johor Bahru in the same timezone as Kuala Lumpur
    "Kuantan": "Asia/Kuala_Lumpur",  # Kuantan in the same timezone as Kuala Lumpur
    "Alor Setar": "Asia/Kuala_Lumpur",  # Alor Setar in the same timezone as Kuala Lumpur
    "Seremban": "Asia/Kuala_Lumpur",  # Seremban in the same timezone as Kuala Lumpur
    "Taiping": "Asia/Kuala_Lumpur",  # Taiping in the same timezone as Kuala Lumpur
    "Kangar": "Asia/Kuala_Lumpur",  # Kangar in the same timezone as Kuala Lumpur
    "Kuala Terengganu": "Asia/Kuala_Lumpur",  # Kuala Terengganu in the same timezone as Kuala Lumpur
    "Batu Pahat": "Asia/Kuala_Lumpur",  # Batu Pahat in the same timezone as Kuala Lumpur
    "Bintulu": "Asia/Kuching",  # Bintulu in the same timezone as Kuching
    "Pasir Gudang": "Asia/Kuala_Lumpur",  # Pasir Gudang in the same timezone as Kuala Lumpur
    "Sibu": "Asia/Kuching",  # Sibu in the same timezone as Kuching
    "Sandakan": "Asia/Kuala_Lumpur",  # Sandakan in the same timezone as Kuala Lumpur
    "Selayang": "Asia/Kuala_Lumpur",  # Selayang in the same timezone as Kuala Lumpur
    "Shah Alam": "Asia/Kuala_Lumpur",  # Shah Alam in the same timezone as Kuala Lumpur
    "Muar": "Asia/Kuala_Lumpur",  # Muar in the same timezone as Kuala Lumpur
    "Tawau": "Asia/Kuala_Lumpur",  # Tawau in the same timezone as Kuala
}   #AI generated
